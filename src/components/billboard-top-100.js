...
function getCoverFromChartItem(chartItem, rank) {
  ...
  try {
    if (rank === 1) {
      if (
        typeof chartItem.children[1].children[3].children[5].attribs[
          "data-srcset"
        ] === "undefined"
      ) {
        cover =
          chartItem.children[1].children[3].children[5].attribs["data-src"];
      } else if (
        chartItem.children[1].children[3].children[5].attribs[
          "data-srcset"
        ].split(" ").length === 8
      ) {
        [
        ...
        [, , , , cover] = chartItem.children[1].children[3].children[5].attribs[
          "data-srcset"
        ].split(" ");
      }
    } else {
      for (
        let i = 0;
        i < chartItem.children[1].children[3].children.length;
        i += 1
      ) {
        if (chartItem.children[1].children[3].children[i].name === "img") {
          if (
            typeof chartItem.children[1].children[3].children[i].attribs[
              "data-srcset"
            ] === "undefined"
          ) {
            cover = chartItem.children[1].children[3].children[i].attribs.src;
          } else if (
            chartItem.children[1].children[3].children[i].attribs[
              "data-srcset"
            ].split(" ").length === 8
          ) {
            [, , , , , , cover] = chartItem.children[1].children[3].children[
              i
            ].attribs["data-srcset"].split(" ");
          } else if (
            chartItem.children[1].children[3].children[i].attribs[
              "data-srcset"
            ].split(" ").length === 6
            ...
            [, , cover] = chartItem.children[1].children[3].children[i].attribs[
              "data-srcset"
            ].split(" ");
          }
          break;
...
function getPositionLastWeekFromChartItem(chartItem) {
  ...
  try {
    if (chartItem.children[3].children.length > 5) {
      positionLastWeek =
        chartItem.children[3].children[5].children[3].children[3].children[0]
          .data;
    } else {
      positionLastWeek =
        chartItem.children[3].children[3].children[1].children[3].children[0]
          .data;
    }
  } catch (e) {
    positionLastWeek = "";
...
function getPeakPositionFromChartItem(chartItem) {
  ...
  try {
    if (chartItem.children[3].children.length > 5) {
      peakPosition =
        chartItem.children[3].children[5].children[5].children[3].children[0]
          .data;
    } else {
      peakPosition =
        chartItem.children[3].children[3].children[3].children[3].children[0]
          .data;
    }
  } catch (e) {
...
function getWeeksOnChartFromChartItem(chartItem) {
  ...
  try {
    if (chartItem.children[3].children.length > 5) {
      weeksOnChart =
        chartItem.children[3].children[5].children[7].children[3].children[0]
          .data;
    } else {
      weeksOnChart =
        chartItem.children[3].children[3].children[5].children[3].children[0]
          .data;
    }
  } catch (e) {
    weeksOnChart = "1";
...
function getNeighboringChart(chartItem, neighboringWeek) {
  if (neighboringWeek === NeighboringWeek.Previous) {
    if (
      chartItem[0].attribs.class.indexOf(
    ...
    chartItem[1].attribs.class.indexOf(
      "dropdown__date-selector-option--disabled"
    ) === -1
  ) {
    return {
...
function getChart(name, date, cb) {
  ...
  request(requestURL, (error, response, html) => {
    ...
    // get chart week
    chart.week = yyyymmddDateFromMonthDayYearDate(
      $(
        ".chart-detail-header__date-selector-button"
      )[0].children[0].data.replace(/\n/g, "")
    );
    // get previous and next charts
    chart.previousWeek = getNeighboringChart(
      $(".dropdown__date-selector-option "),
      NeighboringWeek.Previous
    );
    chart.nextWeek = getNeighboringChart(
      $(".dropdown__date-selector-option "),
      NeighboringWeek.Next
    );
